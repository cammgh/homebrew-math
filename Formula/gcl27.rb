class Gcl27 < Formula
  ...
  url "git://git.sv.gnu.org/gcl.git",
      tag:      "Version_2_7_2pre_homebrew8", # Replace with your target version tag
      revision: "3432bf87f4157fcdf04cec122380b5bc7020ac43" # Replace with the exact Git commit hash
