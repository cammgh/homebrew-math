class Gcl27 < Formula
  ...
  url "git://git.sv.gnu.org/gcl.git",
      tag:      "Version_2_7_2pre_homebrew9", # Replace with your target version tag
      revision: "eb4038782f7b56b9c042e78d33425051ef1845c4" # Replace with the exact Git commit hash
