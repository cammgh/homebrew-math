class Gcl27 < Formula
  ...
  url "git://git.sv.gnu.org/gcl.git",
      tag:      "Version_2_7_2pre_homebrew12", # Replace with your target version tag
      revision: "b24af6d5b612cfa7338271ebda6a3814782041b3" # Replace with the exact Git commit hash
