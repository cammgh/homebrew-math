class Gcl27 < Formula
  ...
  url "git://git.sv.gnu.org/gcl.git",
      tag:      "Version_2_7_2pre_homebrew13", # Replace with your target version tag
      revision: "61c7ce80ccbb46c0805ec2998d453492de137412" # Replace with the exact Git commit hash
